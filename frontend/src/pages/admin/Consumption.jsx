    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center space-x-6 bg-white p-6 rounded-[2rem] border border-border shadow-sm">
        ...
        <div className="px-5 py-2.5 bg-primary/5 rounded-xl text-[10px] font-black text-primary uppercase tracking-[0.2em]">
           {filtered.length} READINGS INDEXED
        </div>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50/50 border-b border-border text-gray-900">
              <th className="p-6 font-black text-xs uppercase tracking-widest pl-10">Hardware Ref</th>
              <th className="p-6 font-black text-xs uppercase tracking-widest">Target Consumer</th>
              <th className="p-6 font-black text-xs uppercase tracking-widest">Billing Period</th>
              <th className="p-6 font-black text-xs uppercase tracking-widest">Utilization (kWh)</th>
              <th className="p-6 font-black text-xs uppercase tracking-widest">Entry Date</th>
              ...
              <tr key={r.id} className="group hover:bg-gray-50/30 transition-colors">
                ...
                <td className="p-6 pr-10 text-right">
                   <div className="flex items-center justify-end space-x-2 opacity-30 group-hover:opacity-100 transition-opacity">
                      <Link to={`/admin/consumption/${r.id}`} className="p-2.5 bg-[#0F172A] text-white hover:bg-black rounded-xl transition-all shadow-lg active:scale-95 flex items-center space-x-2 text-[10px] font-black uppercase tracking-widest">
                         <Eye size={16}/>
                         <span>Audit</span>
                      </Link>
                   </div>
