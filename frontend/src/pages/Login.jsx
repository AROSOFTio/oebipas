...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#303dac] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[460px] animate-slide-up-fade rounded-[2rem] border border-white/70 bg-white p-7 shadow-[0_24px_70px_rgba(15,23,42,0.18)] sm:p-10">
        <div className="animate-slide-up-fade" style={{ animationDelay: '0.1s' }}>
          <div className="mb-8 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--accent-soft)] shadow-[0_12px_30px_rgba(53,67,187,0.16)]">
